...
def filter_questions():
    with open('/groups/sernam/datasets/vqa/vqav2/v2_OpenEnded_mscoco_val2014_questions.json', 'r') as f:
        questions = json.load(f)['questions']

    filtered = []
    with open('/groups/sernam/datasets/vqa/vqav2/coco2014val_questions.json', 'a') as f:
...
def filter_annotations():
    ...
    with open('/groups/sernam/datasets/vqa/vqav2/coco2014val_annotations.json', 'w') as f:
        json.dump(result, f)
...
def filter_question(path, save_path):
...
if __name__ == '__main__':
    questions_to_llava_format("/groups/sernam/datasets/vqa/vqav2/coco2014val_questions.json", "/groups/sernam/datasets/vqa/vqav2/coco2014val_questions_llava.jsonl")
